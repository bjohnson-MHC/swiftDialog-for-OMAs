...
These scripts are tested for compatibility with swiftDialog 3.0 as of 21 June, 2026. 

*The resources need to be checked as Bart has moved the documentation to a separate website.*
